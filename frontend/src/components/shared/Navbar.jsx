    ...
    <div className="bg-white sticky top-0 z-50 dark:bg-neutral-900">
      <div className="flex items-center justify-between mx-auto max-w-5xl px-2 shadow-sm h-16">
        ...
        <div
          ...
          } md:flex flex-col md:flex-row items-center gap-5 md:gap-10 absolute md:static top-16 left-0 right-0 bg-white dark:bg-neutral-900 md:bg-transparent p-5 md:p-0 md:h-auto shadow-md md:shadow-none`}
        >
          <ul className="flex flex-col md:flex-row font-medium items-center gap-5">
            ...
            {user?.role === "recruiter" ? (
              <>
                <li>
                  <Link to={"/admin/jobs"}>Your Jobs</Link>
                </li>
                <li>
          ...
          {/* User actions (Login/Signup or Profile/Logout) */}
          {!user ? (
